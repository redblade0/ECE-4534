...
HAL HAL_construct()
{
    ...
    hal.boosterpackRed = LED_construct(GPIO_GRP_0_BOOSTERPACK_LED_RED_PORT, GPIO_GRP_0_BOOSTERPACK_LED_RED_PIN);

    hal.boosterpackGreen = LED_construct(GPIO_GRP_0_BOOSTERPACK_LED_GREEN_PORT, GPIO_GRP_0_BOOSTERPACK_LED_GREEN_PIN);
